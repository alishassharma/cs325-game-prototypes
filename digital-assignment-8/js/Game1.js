export class Game1 extends Phaser.Scene {
    ...
    create() {
        var levelText = this.add.text(20, 20, 'Level 1', { fontSize: '32px', fill: '#000000' });
        ...
        platforms.create(440, 500, 'platform1').refreshBody().setScale();
        var vertplat = platforms.create(280, 200, 'platform1').refreshBody().setScale();
        vertplat.angle = 90;
        platforms.create(530, 420, 'platform1').refreshBody().setScale();
