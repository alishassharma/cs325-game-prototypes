export class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('titlePage', 'assets/MainMenuScreen.png');
        this.load.atlas('playButton', 'assets/play_button1.png', 'assets/play_button.json');
        //this.load.atlas('playButton', 'assets/play_button.png', 'assets/play_button.json');
        this.load.audio('titleMusic', ['assets/MainMenuSong.mp3']);
        //	+ lots of other required assets here

        this.load.spritesheet( 'player', 'assets/character.png', {frameWidth: 53, frameHeight: 75});
        this.load.image('rectangle', 'assets/rectangle.png');
        this.load.image('platform1', 'assets/smallplatform.png');
        this.load.spritesheet( 'portal', 'assets/portal.png', {frameWidth: 250, frameHeight: 592});
        this.load.audio('mainmusic', 'assets/music.mp3');
