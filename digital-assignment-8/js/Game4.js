export class Game4 extends Phaser.Scene {
    ...
    create() {
        var levelText = this.add.text(20, 20, 'Level 4', { fontSize: '32px', fill: '#000000' });
        ...
        var movingplat1 = movingplatforms.create(200, 195, 'platform1').setScale();
        this.tweens.add({
            targets: movingplat1,
            x: 600,
            duration: 700,
        ...
        var movingplat2 = movingplatforms.create(200, 410, 'platform1').setScale();
        this.tweens.add({
            targets: movingplat2,
            x: 600,
            duration: 700,
